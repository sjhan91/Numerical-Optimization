...
range_powell = 10; % direction vector, starting point initialized in range of [-30, 30]
epsilon_powell = 0.01; % termination condition - the average of vertex distance <= epsilon
