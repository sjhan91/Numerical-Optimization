...
%% Problem 2 - find local minima (x^3 - 3*x^2 + 2)
clc;
clear;
close all;
...
fprintf('2. Bisection - It takes %fsec to generate local minima %f at %f, when derivative of f(x) = %f\n', time, local_min, opt_x, opt_y);
...
local_min = double(f(opt_x));
fprintf('2. Newton - It takes %fsec to generate local minima %f at %f, when derivative of f(x) = %f\n', time, local_min, opt_x, opt_y);
...
local_min = double(f(opt_x));
fprintf('2. Secant - It takes %fsec to generate local minima %f at %f, when derivative of f(x) = %f\n', time, local_min, opt_x, opt_y);
...
local_min = double(f(opt_x));
fprintf('2. Regula - It takes %fsec to generate local minima %f at %f, when derivative of f(x) = %f\n', time, local_min, opt_x, opt_y);